        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 py-24 sm:py-32">
          <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8 animate-fade-in">
            ...
            <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold text-white leading-tight tracking-tight animate-slide-up px-4" style={{ animationDelay: '0.2s' }}>
              Explore <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-200">Alleppey's</span> beauty
              <br className="hidden sm:block" />
              with speed & style
            </h1>

            <p className="text-base sm:text-lg md:text-2xl text-gray-300 max-w-2xl mx-auto leading-relaxed animate-slide-up px-4" style={{ animationDelay: '0.3s' }}>
              Experience the thrill of green tourism in Alappuzha's serene backwaters.
              Fast, safe, and unforgettable journeys await.
            </p>
            ...
            <p className="text-xs sm:text-sm text-emerald-400/80 tracking-wider sm:tracking-[0.2em] uppercase pt-6 sm:pt-8 animate-slide-up px-4" style={{ animationDelay: '0.5s' }}>
              No big deal, it's just Alleppey — Just ride with us
            </p>
          </div>
        </div>
